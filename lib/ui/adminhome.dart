...
class _AdminHomePageMobileState extends State<AdminHomePageMobile> {
  ...
  Widget build(BuildContext context) {
    ...
    TextStyle title =  TextStyle(fontSize: 22,fontFamily:"Ubuntu",fontWeight: FontWeight.w500,color: Colors.pinkAccent);
                    ...
                    Row(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text("Doctor Hub",style: TextStyle(fontSize:25,fontFamily: "Ubuntu",foreground: Paint()..shader = LinearGradient(
                ...
                height: 500,
                 ...
                 child: Column(
                   ...
                   children: [
                             ...
                             children: [
                              Padding(
                               ...
                               Padding(
                                 ...
                                 child: IconButton(
                                   icon: Icon(Icons.navigate_next,color: Colors.pinkAccent),
                                   iconSize: 40,
                                   onPressed: (){
                                     Navigator.of(context).push(CupertinoPageRoute(builder: (context)=>PatientHomePageMobile()));
                                   },
                         ...
                         child: Container(
                           ...
                           child: Row(
                             ...
                             children: [
                               Padding(
                                 padding: const EdgeInsets.only(left: 15),
                                 child: Image.asset("assets/images/task.png",width: 50,height: 50,),
                               ),
                               Padding(
                                 padding: const EdgeInsets.only(left: 30,top: 23),
                                 child: Column(
                     ...
                     GestureDetector(
                       onTap:(){
                         Navigator.of(context).push(CupertinoPageRoute(builder: (context)=>TaskHomePageMobile()));
                       } ,
                       child: Padding(
                         padding: const EdgeInsets.only(left: 15,right:15,top: 7),
                         child: Container(
                           ...
                           child: Row(
                             ...
                             children: [
                               Padding(
                                 ...
                                 child: Image.asset("assets/images/completed-task.png",width: 45,height: 45,),
                               ),
                               Padding(
                                 padding: const EdgeInsets.only(left: 30,top: 23),
                                 child: Column(
                                   ...
                                   children: [
                                     ...
                                     Padding(
                                       padding: const EdgeInsets.only(top: 7),
                                       child: Text("Save your notes ",style: desc,),
                                     ),
                                   ],
                                 ),
                               ),
                         ...
                         child: Container(
                           ...
                           child: Row(
                             ...
                             children: [
                               Padding(
                                 padding: const EdgeInsets.only(left: 25),
                                 child: Image.asset("assets/images/doctorvector.png",width: 45,height: 45,),
                               ),
                               Padding(
                                 padding: const EdgeInsets.only(left: 30,top: 23),
                                 child: Column(
